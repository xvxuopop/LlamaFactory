...
if __name__ == "__main__":
    ...
    sample_base = {
        "messages": [
            ...
            },
            {
                "role": "user",
                "content": [
                    {"type": "text", "value": "Can you tell me a joke?"},
                    {
                        "type": "video",
                        "value": "/home/j30074199/tasks/llamafactory/template/LlamaFactory/data/mllm_demo_data/1.mp4",
                    },
                ],
            },
        ],
    ...
    rendered_output_base = RenderingPlugin("qwen3_vl").render_messages(processor, sample_base["messages"])
